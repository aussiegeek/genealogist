defmodule Genealogist.Graphviz do
  @moduledoc """
  Takes a tree generated by `Genealogist.Builder.tree/1` and returns a graph that the `dotex` hex package can turn in to a Graphviz graph
  """
  ...
  defp add_connections(graph, [{:supervisor, node, children}|t]) do
    ...
    graph
    |> Graph.add_connection(node, child_nodes)
